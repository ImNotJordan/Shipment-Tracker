...
export function CreateCompanyDialog({
  ...
  // Read off the logo, never chosen: a board wears its own mark.
  const [ground, setGround] = useState<BoardGround | null>(FALLBACK.ground);
    ...
    >
      <form className="ops-form ops-create" onSubmit={submit}>
        ...
        <p className="ops-meta">
          {logo
            ? "The board wears this logo. Pick the colour it washes over."
